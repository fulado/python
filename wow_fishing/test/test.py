...
# 首次甩出鱼漂
def throw_float():
    print('====== 10秒后开始识别鱼漂, 请用鼠标点击魔兽窗口后将鼠标移至屏幕边缘, 并保存窗口在最前并不被其它窗口遮挡 ======')
    for i in range(10):
        print('====== %d ======' % (10 - i))
        time.sleep(1)
...
def main():
    ...
    # target_rgb_dark = (75, 54, 37)  # 搜索目标的rgb值 光线暗
    # target_rgb_dark = (240, 41, 11)  # 搜索目标的rgb值 光线暗

    target_rgb_got = (250, 250, 250)  # 鱼上钩后的rgb值
