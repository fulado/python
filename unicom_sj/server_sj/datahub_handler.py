...
class DatahubHandler(object):
    def __init__(self):
        ...
        # topic_name
        self.topic_signal_controller = 'ods_devc_signal_info_gb1049_songjiang'
        self.topic_lamp_param = 'ods_signal_lightset_froad_rltn_gb1049_songjiang'
        self.topic_lane_param = 'ods_signal_froad_info_gb1049_songjiang'
        self.topic_stage_param = 'ods_signal_stage_info_gb1049_songjiang'
        self.topic_plan_param = 'ods_signal_timeplan_config_gb1049_songjiang'
        self.topic_phase_param = 'ods_signal_phase_lane_rltn_gb1049_songjiang'
        self.topic_cross_cycle = 'ods_signal_cycle_rt_gb1049_songjiang'
        self.topic_cross_stage = 'ods_signal_stage_rt_gb1049_songjiang'
        self.topic_cross_traffic = 'ods_signal_traffic_data_rt_gb1049_songjiang'
        ...
        self.schema_cross_traffic = self.dh.get_topic(self.project_name, self.topic_cross_traffic).record_schema
